    ...
    public class DESBuilder
    {
        ...
        public void AddWholeDES(BitArray key)
        {
            ...
            for (int cycleNumber = 0; cycleNumber < 16; cycleNumber++)
            {
                ...
                _decryptSteps.Add(extendingPermutationTransformation);
                ...
                //addSBlocks
                _encryptSteps.Add(new DataTransformation(SBlocks));
                _decryptSteps.Add(new DataTransformation(SBlocks));

                //add PBlocks
                _encryptSteps.Add(new DataTransformation(PblockPermutation));
                _decryptSteps.Add(new DataTransformation(PblockPermutation));
        ...
        {
            dataSet.Right = SumModuloTwo(key, dataSet.Right);
            return dataSet;
        }
        ...
        public DataSet ExtendingPermutation(DataSet dataSet)
        {
